...
Original file is located at
    https://colab.research.google.com/drive/1kNqUo4Lf49Vo6ZppUPlh2EmdExNjy-qM
"""
...
def load_granite_model(hf_token, progress=gr.Progress()):
    ...
    try:
        ...
        return "✅ Model loaded successfully! You can now generate audiobooks."
...
def rewrite_text_with_tone(text, tone, progress=gr.Progress()):
    ...
    if not text.strip():
        return "❌ Please enter some text to rewrite!", None, None
...
Rewritten Text:"""
    ...
    try:
        ...
        return f"✅ Text rewritten successfully with {tone} tone!", rewritten, rewritten

    except Exception as e:
        return f"❌ Error during text rewriting: {str(e)}", None, None
...
def generate_audio(rewritten_text, voice_choice, progress=gr.Progress()):
    ...
    if not rewritten_text or not rewritten_text.strip():
        return "❌ No text to convert to audio!", None
    ...
    try:
        ...
        return f"✅ Audio generated successfully with {voice_choice} voice!", temp_file.name
...
def process_audiobook(input_text, tone, voice_choice):
    ...
    if not model_loaded:
        return (
            "❌ Please load the model first using the Configuration tab!",
            None,
            None,
            None,
            None,
...
with gr.Blocks(theme=gr.themes.Soft(), title="AI Audiobook Creator") as demo:
    ...
    with gr.Tabs() as tabs:
        ...
        with gr.Tab("⚙ Configuration"):
            ...
            hf_token_input = gr.Textbox(label="🔑 Hugging Face Access Token", type="password", placeholder="Enter your HF token here")
        ...
        # Generation Tab
        with gr.Tab("🎬 Generate Audiobook"):
            ...
            with gr.Accordion("📝 Tone-Adapted Text", open=True):
